...
export default function Navbar() {
  ...
  const handleNavigation = (href: string) => {
    setActiveDropdown(null)
    setIsOpen(false)
    // No delays - let Next.js handle the navigation immediately
  }
        ...
        <div className="container mx-auto px-8">
          <div className="flex h-24 items-center justify-between">
                  ...
                  <div key={index} className="nav-item relative">
                    {item.hasDropdown ? (
                        ...
                        >
                          ...
                          {/* Dropdown Menu with Full Green Background */}
                          {activeDropdown === item.name && (
                              <div
                                  className="absolute top-full left-0 mt-2 w-48 bg-[#95C149] backdrop-blur-2xl shadow-xl shadow-black/10 border border-[#95C149] py-2 z-50"
                              >
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="bg-[#95C149] backdrop-blur-2xl border-l border-[#95C149] w-80">
