  ...
  const blogPosts = [
    {
      ...
      link: "https://navtechno.in/lifi-data-transmission-visible-light/",
    },
    {
      ...
      link: "https://navtechno.in/lifi-is-transforming-smart-homes/",
    },
    {
      title:
          "The Future Of Li-Fi Technology: Key Trends And Predictions For 2025",
      date: "June 30, 2025",
      comments: "3 Comments",
      excerpt:
      ...
      link: "https://navtechno.in/future-of-li-fi-technology-trends-2025/",
    },
    {
      title: "Data Transmission Using Visible Light In Li-Fi Technology",
      date: "June 30, 2025",
    ...
    },
    {
      ...
      link: "https://example.com/blog/future-lifi-technology-trends-2025-2",
    },
    {
      title: "Data Transmission Using Visible Light In Li-Fi Technology",
      date: "June 30, 2025",
      ...
      link: "https://example.com/blog/data-transmission-visible-light-lifi-3",
    },
    {
      title: "How LiFi Is Transforming Smart Homes",
      date: "June 30, 2025",
      ...
      link: "https://example.com/blog/lifi-transforming-smart-homes-3",
    },
    {
      title:
          "The Future Of Li-Fi Technology: Key Trends And Predictions For 2025",
      ...
      link: "https://example.com/blog/future-lifi-technology-trends-2025-3",
    },
  ];
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
              ...
              <div className="flex justify-center mb-12">
                <div className="flex bg-gray-200 rounded-full p-1">
                  <Button
                      ...
                      style={{
                        backgroundColor:
                            activeTab === "media" ? "#95C149" : "transparent",
                      }}
                  >
                    Media
                  </Button>
                  <Button
                      ...
                      style={{
                        backgroundColor:
                            activeTab === "blogs" ? "#95C149" : "transparent",
                      }}
                  >
                    Blogs
                  </Button>
              ...
              {activeTab === "media" && (
                  <div className="animate-in">
                    <h2 className="text-5xl font-oswald font-semibold text-black text-center mb-16">
                      MEDIA
                    </h2>
                    <div className="space-y-20">
                      {mediaArticles.map((article, index) => (
                          <div key={index} className="max-w-4xl mx-auto">
                            <h3 className="text-3xl font-oswald font-semibold text-black mb-3">
                              {article.title}
                            </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                      {blogPosts.map((post, index) => (
                          <div key={index} className="overflow-hidden">
                            ...
                            <div className="pt-6">
                              <h3 className="text-lg font-oswald font-semibold text-black mb-3 line-clamp-2 leading-tight">
                                {post.title}
                              </h3>
                              ...
                              <button
                                  ...
                                  className="font-medium text-sm hover:opacity-80 transition-opacity duration-200 cursor-pointer"
                                  style={{ color: "#95C149" }}
                              >
                                Read More
                              </button>
