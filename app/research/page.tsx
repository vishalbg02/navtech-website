...
export default function ResearchPage() {
  ...
  const researchAreas = [
    ...
    },
    {
      ...
      image: "/images/Wireless Electricity.jpeg",
    },
    {
      id: "pof",
    ...
    },
    {
      ...
      image: "/images/Next Gen Chip.jpeg",
    },
    {
      id: "pat",
      ...
      <div className="relative z-10">
        ...
        <section ref={introRef} className="py-16 px-8">
          <div className="container mx-auto text-center">
            ...
            >
              <motion.h2
                className="font-oswald font-semibold text-5xl text-black mb-8"
                variants={fadeInUp}
              >
              ...
              <motion.p
                ...
                variants={fadeInUp}
              >
                Optical Wireless Technology (OWT) is an advanced method of
                wireless communication and power delivery that enables
                ultra-fast, interference-free, and license-free data
                connectivity while also supporting simultaneous wireless energy
                transmission.
              </motion.p>
            </motion.div>
          </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <h3
                          className="text-black mb-6 leading-tight font-oswald font-semibold"
                          style={{ fontSize: "36px" }}
                        >
                          {area.subtitle}
                        </h3>
