        ...
        >
          <div className="max-w-full">
            <div className="grid lg:grid-cols-2 items-center gap-0">
              {/* Left: Text Content */}
              <motion.div
                className="px-4 sm:px-6 lg:pl-8 xl:pl-[120px] order-2 lg:order-1 max-w-7xl mx-auto lg:mx-0"
                variants={fadeInLeft}
                initial="hidden"
              ...
              <motion.div
                className="relative h-[300px] sm:h-[400px] lg:h-[441px] w-full overflow-hidden order-1 lg:order-2 pb-20 pl-4 pr-4 md:pl-0 md:pr-0 md:pb-0"
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm sm:text-base leading-relaxed text-gray-700">
                    ...
                    connecting government outposts in hilly, forested, or
                    coastal regions.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-[120px]">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 text-sm sm:text-base leading-relaxed">
                ...
                <p>
                  <strong className="text-black">
                    Telemedicine & e-Hospitals:
                  </strong>
                  <br />
                  Secure, interference-free wireless data for medical
                  diagnostics, patient records, and real-time specialist
                  consultations.
                </p>
              </div>
            </motion.div>
