                                ...
                                <div className="p-8 md:w-2/3">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-10">
                                        <div className="grid md:grid-cols-2 gap-10">
                                            <div>
                                                <label className="text-base font-semibold text-gray-800 mb-2 block">Name</label>
                                                <Input
                                                    name="fullName"
                                            ...
                                            <div>
                                                <label className="text-base font-semibold text-gray-800 mb-2 block">Email</label>
                                                <Input
                                                    name="email"
                                                    type="email"
                                        ...
                                        <div className="grid md:grid-cols-2 gap-10">
                                            <div>
                                                <label className="text-base font-semibold text-gray-800 mb-2 block">Phone</label>
                                                <Input
                                                    name="phone"
                                                    type="tel"
                                            ...
                                            <div>
                                                <label className="text-base font-semibold text-gray-800 mb-2 block">Designation</label>
                                                <Input
                                                    name="designation"
                                        ...
                                        <div>
                                            <label className="text-base font-semibold text-gray-800 mb-2 block">Message</label>
                                            <Textarea
                                                name="message"
