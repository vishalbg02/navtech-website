            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInLeft(0)} className="mb-12">
                            ...
                            <ul className="space-y-4 text-gray-700">
                                ...
                                <li>
                                    ...
                                    refers to Nav Wireless Technologies Pvt Ltd, C-5, LiFi, The First, Near ITC Narmada Hotel.
                                </li>
                                <li>
                        ...
                        <motion.div variants={fadeInLeft(0.1)} className="mb-12">
                            ...
                            <div className="space-y-4 text-gray-700 leading-relaxed">
                                <p>
                                    ...
                                    You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.
                                </p>
                                <p>
                        ...
                        <motion.div variants={fadeInLeft(0.6)} className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
                            <div className="space-y-4 text-gray-700 leading-relaxed">
                                <p>
                                    The Service is provided to You "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of any kind.
                                    To the maximum extent permitted under applicable law, the Company, on its own behalf and on behalf of its Affiliates and its
                                    and their respective licensors and service providers, expressly disclaims all warranties, whether express, implied, statutory
                                    or otherwise, with respect to the Service, including all implied warranties of merchantability, fitness for a particular purpose,
                                    title and non-infringement, and warranties that may arise out of course of dealing, course of performance, usage or trade practice.
                                </p>
                                <p>
                                    Without limitation to the foregoing, the Company provides no warranty or undertaking, and makes no representation of any kind
                                    that the Service will meet Your requirements, achieve any intended results, be compatible or work with any other software,
                                    applications, systems or services, operate without interruption, meet any performance or reliability standards or be error free
                        ...
                        {/* Additional Sections */}
                        <motion.div variants={fadeInLeft(0.7)} className="mb-12">
                            ...
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Disputes Resolution</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by
                                contacting the Company.
                            </p>

                            <h2 className="text-3xl font-bold text-gray-900 mb-6">For European Union (EU) Users</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                            ...
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">United States Legal Compliance</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                            ...
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Severability and Waiver</h2>

                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Severability</h3>
                            ...
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Waiver</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                            ...
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Translation Interpretation</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                These Terms and Conditions may have been translated if We have made them available to You on our Service.
                                You agree that the original English text shall prevail in the case of a dispute.
                            </p>

                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Changes to These Terms and Conditions</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                            ...
                            <ul className="text-gray-700">
                                <li>
                                    By email:{" "}
                                    <a href="mailto:hardik.soni@navwireless.com" className="text-blue-600 hover:text-blue-800 underline">
