        ...
        <div className="relative min-h-screen bg-white overflow-x-hidden">
            ...
            <section className="pt-32 pb-16 px-4 bg-gradient-to-br from-gray-50 to-white">
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <motion.div variants={fadeInUp(0)} className="w-full flex justify-center">
                        ...
                        <motion.p
                            ...
                            className="text-lg text-gray-700 max-w-4xl mx-auto mt-4 text-center"
                        >
                            This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
                        </motion.p>
                        <motion.p
                            variants={fadeInUp(0.4)}
                            className="text-lg text-gray-700 max-w-4xl mx-auto mt-2 text-center"
                        >
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInLeft(0)} className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Interpretation and Definitions</h2>

                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Interpretation</h3>
                            ...
                            <ul className="space-y-4 text-gray-700">
                                ...
                                <li>
                                    <strong>Business</strong>, for the purpose of CCPA/CPRA, refers to the Company as the legal entity that collects
                                    Consumers' personal information and determines the purposes and means of the processing of Consumers' personal information,
                                    or on behalf of which such information is collected and that alone, or jointly with others, determines the purposes and
                                    means of the processing of consumers' personal information, that does business in the State of California.
                                </li>
                                <li>
                                    <strong>CCPA</strong> and/or <strong>CPRA</strong> refers to the California Consumer Privacy Act (the "CCPA") as
                                ...
                                <li>
                                    ...
                                    Nav Wireless Technologies Pvt Ltd, C-5, LiFi, The First, Near ITC Narmada Hotel, Ahmedabad - 380015, Gujarat, India.
                                    <br /><br />
                                    For the purpose of the GDPR, the Company is the Data Controller.
                                </li>
                                <li>
                                    <strong>Consumer</strong>, for the purpose of the CCPA/CPRA, means a natural person who is a California resident.
                                ...
                                <li>
                                    ...
                                    Company as the legal person which alone or jointly with others determines the purposes and means of the processing
                                    of Personal Data.
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>Do Not Track</strong> (DNT) is a concept that has been promoted by US regulatory authorities, in particular
                                    the U.S. Federal Trade Commission (FTC), for the Internet industry to develop and implement a mechanism for allowing
                                ...
                                <li>
                                    ...
                                    <br /><br />
                                    For the purposes of GDPR, Personal Data means any information relating to You such as a name, an identification
                                    number, location data, online identifier or to one or more factors specific to the physical, physiological, genetic,
                                    mental, economic, cultural or social identity.
                                    <br /><br />
                                    For the purposes of the CCPA/CPRA, Personal Data means any information that identifies, relates to, describes or is
                                ...
                                <li>
                                    <strong>Website</strong> refers to Nav Wireless Technologies Pvt Ltd, accessible from{" "}
                                    <a href="https://www.navwireless.com" className="text-blue-600 hover:text-blue-800 underline"
                        ...
                        <motion.div variants={fadeInLeft(0.1)} className="mb-12">
                            ...
                            <h4 className="text-xl font-semibold text-gray-800 mb-3">Personal Data</h4>
                            ...
                            <h4 className="text-xl font-semibold text-gray-800 mb-3">Information from Third-Party Social Media Services</h4>
                            <div className="space-y-4 text-gray-700 leading-relaxed mb-6">
                        ...
                        <motion.div variants={fadeInLeft(0.2)} className="mb-12">
                            <h4 className="text-xl font-semibold text-gray-800 mb-3">Tracking Technologies and Cookies</h4>
                        ...
                        <motion.div variants={fadeInLeft(0.3)} className="mb-12">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Use of Your Personal Data</h3>
                        ...
                        {/* GDPR Privacy */}
                        <motion.div variants={fadeInLeft(0.4)} className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">GDPR Privacy</h2>

                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Legal Basis for Processing Personal Data under GDPR</h3>
                            <p className="text-gray-700 mb-4">We may process Personal Data under the following conditions:</p>
                            <ul className="space-y-3 text-gray-700 mb-6">
                                ...
                                <li>
                                    <strong>Legal obligations:</strong> Processing Personal Data is necessary for compliance with a legal obligation to
                                    which the Company is subject.
                                </li>
                                <li>
                                    <strong>Vital interests:</strong> Processing Personal Data is necessary in order to protect Your vital interests or
                            ...
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Your Rights under the GDPR</h3>
                            ...
                            <ul className="space-y-3 text-gray-700">
                                ...
                                <li>
                                    <strong>Request correction of the Personal Data that We hold about You.</strong> You have the right to have any incomplete
                                    or inaccurate information We hold about You corrected.
                                </li>
                                <li>
                                    <strong>Object to processing of Your Personal Data.</strong> This right exists where We are relying on a legitimate interest
                                    as the legal basis for Our processing.
                                </li>
                                <li>
                                    <strong>Request erasure of Your Personal Data.</strong> You have the right to ask Us to delete or remove Personal Data when
                                ...
                                <li>
                                    <strong>Withdraw Your consent.</strong> You have the right to withdraw Your consent on using your Personal Data.
                                </li>
                            </ul>
                        </motion.div>

                        {/* Security and Contact Information */}
                        <motion.div variants={fadeInLeft(0.5)} className="mb-12">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Security of Your Personal Data</h3>
                            ...
                            <ul className="text-gray-700">
                                <li>
                                    By email:{" "}
                                    <a href="mailto:info@navtechno.in" className="text-blue-600 hover:text-blue-800 underline">
                                        info@navtechno.in
                                    </a>
                                </li>
                                <li className="mt-2">
