      ...
      <section className="pt-32 pb-16 px-4 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center justify-center text-center w-full">
            ...
            <p className="text-lg text-gray-700 max-w-4xl mx-auto mt-2 text-center">
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-4 text-gray-700">
                ...
                <li>
                  ...
                  the California Consumer Privacy Act (the "CCPA") as amended by
                ...
                <li>
                  ...
                  Hotel, Ahmedabad - 380015, Gujarat, India.
                  <br />
                  <br />
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li>
                  ...
                  interest as the legal basis for Our processing.
                </li>
                <li>
